object LearningScala3 {
  ...
  def testUpperCase(f: String => String) = { println(f("asdasd")); println(f("ASD123!eaAD9")); }
                                                  //> testUpperCase: (f: String => String)Unit
                                                  
  testUpperCase (toUpperCase)                     //> ASDASD
                                                  //| ASD123!EAAD9
                                                  
  testUpperCase(x => x.toUpperCase)               //> ASDASD
                                                  //| ASD123!EAAD9
